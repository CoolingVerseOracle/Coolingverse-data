...
def build(manifest_path: Path, input_dir: Path, output_dir: Path, previous_metadata: Path | None) -> dict[str, object]:
    ...
    report = validate(
        ...
        previous_table_rows=previous_counts,
    )
...
def main() -> None:
    ...
    if args.command == "verify-manifest":
        ...
        print(json.dumps(build(args.manifest, args.input_dir, args.output_dir, args.previous_metadata), ensure_ascii=False))
